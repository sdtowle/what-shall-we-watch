...
import type { EnrichedShowData, UserRating } from '@/lib/types';
...
export default function WatchlistShowCard({
  ...
  useEffect(() => {
    getUserRating(show.tmdb_show_id).then(setUserRating);
  }, [show.tmdb_show_id]);
        ...
        <div className="flex items-center justify-between gap-2 mt-auto pt-1">
          <div className="flex items-center gap-2">
            ...
            >
              ...
              {userRating?.score != null && <span>{userRating.score}</span>}
            </button>
          </div>
